let myAccountBalance = document.getElementById("myAccountBalance");

var totalBalance = myAccountBalance.innerHTML;

function sendMoney() {
  var enterName = document.getElementById("enterName").value;
  var enterAmount = parseInt(document.getElementById("enterAmount").value);

  if (enterAmount > totalBalance) {
    ...
    var finalAmount =
      ...
      enterAmount;
    var myAccountBalance = totalBalance - enterAmount;
